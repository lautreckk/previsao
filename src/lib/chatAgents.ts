...
const preloadedMessages: Omit<ChatMessage, "id" | "timestamp">[] = [
  ...
  { user: "cafecombug", text: "over 2.5 ta bugado igual meu deploy, melhor 1.5 safe e sai fora", predictions: 131 },
  ...
  { user: "capivara777", text: "to na duvida no over 2.5 hj... ta com cara de pegadinha, qq vcs acham?", predictions: 221 },
